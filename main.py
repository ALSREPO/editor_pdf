...
def main():
    ...
    while True:
        ...
        print("8) Insertar índice desde archivo TXT")
        print("9) Modificar o ocultar cabecera")
        print("10) Modificar, ocultar o renumerar pie de página")
        print("11) Guardar PDF final en disco")
        print("0) Salir")
        print("----------------------------------")
